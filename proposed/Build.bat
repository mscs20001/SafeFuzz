...
if exist "%MODULE_ROOT_DIR%\trace.out" del "%MODULE_ROOT_DIR%\*_trace.out"
...
cd %CWD%
@echo Generate.bat %MODULE_NAME%
start /w cmd /C Generate.bat %MODULE_NAME%
...
@echo ====================================
@echo Creating Dynamic Call Graphs
@echo ====================================
python CallGraphBuilder.py -o%METRICSDIR%\CallGraph.txt -t%MODULE_ROOT_DIR% -e%MODULE_ROOT_DIR%\out\module\compilers\mingw32\module_emb
...
@echo ====================================
@echo Collecting MISRA Violation Metrices
@echo ====================================
python ViolationCalculator.py -o%METRICSDIR%\Violation.txt -i%KLOCWORK_KWLIST_CSV_FILE% -s%OUTDIR%

@echo ====================================
@echo Collecting History Metrices
@echo ====================================
python HistoryCalculator.py -o%METRICSDIR%\History.txt -s%OUTDIR% --last=%OUTLASTDIR% --lastlast=%OUTLASTLASTDIR%

@echo ====================================
@echo Calculating Function Weights
@echo ====================================
python FunctionWeightCalculator.py -g%METRICSDIR%\CallGraph.txt -c%METRICSDIR%\Complexity.txt -f%METRICSDIR%\Fluctuation.txt -v%METRICSDIR%\Violation.txt -t%METRICSDIR%\History.txt -o%METRICSDIR%\FunctionWeight.txt 
