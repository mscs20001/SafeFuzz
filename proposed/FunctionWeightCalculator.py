...
def parse_args(arg_list):
    ...
    parser.add_argument('-v', action="store", dest="violationFile", required=True)
    parser.add_argument('-t', action="store", dest="historyFile", required=True)
    ...
    print(" - violationFile = " + args.violationFile)
    print(" - historyFile = " + args.historyFile)
    ...
    metrices_dict_list.append(read_metrices(args.violationFile))
    metrices_dict_list.append(read_metrices(args.historyFile))
